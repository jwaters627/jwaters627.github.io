    ...
    d.flexslider = function(j, l) {
        ...
        f = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    f.controlNav.set();
                    f.controlNav.active();
                    a.controlNavScaffold.delegate("a, img", u, function(b) { b.preventDefault();
                        b = d(this);
                ...
                setupManual: function() { a.controlNav = a.manualControls;
                    f.controlNav.active();
                    a.controlNav.live(u, function(b) { b.preventDefault();
                        b = d(this);
                        var g = a.controlNav.index(b);
            ...
            directionNav: {
                setup: function() {
                    ...
                    a.directionNav.bind(u, function(b) { b.preventDefault();
            ...
            pausePlay: {
                setup: function() {
                    ...
                    a.pausePlay.bind(u, function(b) { b.preventDefault();
            ...
            touch: function() {
                function b(b) { k = m ? d - b.touches[0].pageY : d - b.touches[0].pageX;
        ...
        a.setup = function(b) {
            if (s) a.slides.css({
                ...
                marginRight: "-100%",
                position: "relative"
            }), "init" === b && (q ? a.slides.css({ opacity: 0, display: "block", webkitTransition: "opacity " + c.animationSpeed / 1E3 + "s ease", zIndex: 1 }).eq(a.currentSlide).css({ opacity: 1, zIndex: 2 }) : a.slides.eq(a.currentSlide).fadeIn(c.animationSpeed, c.easing)), c.smoothHeight && f.smoothHeight();
            else {
                var g, p;
